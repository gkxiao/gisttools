...
python export_dg.py
```
I have encountered an issue at present in [issue 81](https://github.com/liedllab/gist-tutorial/issues/81), which was solved by doubling Eww. For more detail, see [issue 83](https://github.com/liedllab/gist-tutorial/issues/83)
